...
## Job Name: CiviCRM-WordPress-PR
## Job Description: Monitor civicrm-wordpress.git for proposed changes
##    For any proposed changes, run a few "smoke tests"
## Job GitHub Project URL: https://github.com/civicrm/civicrm-wordpress
...
## Run the tests
#echo civi-test-run -b "$BLDNAME" -j "$JUNITDIR" phpunit-e2e phpunit-wordpress
#$GUARD civi-test-run -b "$BLDNAME" -j "$JUNITDIR" phpunit-e2e phpunit-wordpress
